...
exists("islas")
## El objeto <code>islas</code> no es un <em>data frame</em>.
is.data.frame(islas)
...
## La variable <code>island.area.log</code> no tiene los valores esperados. Asegúrate de haber calculado los logaritmos naturales, con la función <code>log</code>.
