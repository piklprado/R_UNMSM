...
8. Introduzca el número del curso `Curso R UNMSM v#`
...
1. Si ves el mensaje `No. Let me start something new.` Introduzca el número que viene antes de ella. Vá al paso 4.

2. Si todavia no ves el mensaje, escribe `swril()` en la línea de comando.

3. Ahora  debes el mensaje `No. Let me start something new.` Introduzca el número que viene antes de ella. 

4. Introduzca el número del curso `Curso R UNMSM v#` 

5. A el mensaje `Please choose a lesson, or type 0 to return to course menu.` introduzca el número 2.
           
]

---

## Que hacer hasta mañana
